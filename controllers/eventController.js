...
const createEvent = async (req, res) => {
  try {
    ...
    const finalEventData = {
      ...
      bookingOpen:
        req.body.bookingOpen !== undefined ? req.body.bookingOpen : true,
    }
    ...
    // Add optional fields
    if (req.body.guestNames && req.body.guestNames.length > 0)
      finalEventData.guestNames = req.body.guestNames
    if (req.body.performers && req.body.performers.length > 0)
      finalEventData.performers = req.body.performers
    if (req.body.hostedBy) finalEventData.hostedBy = req.body.hostedBy
    if (req.body.tags && req.body.tags.length > 0)
      finalEventData.tags = req.body.tags
    if (req.body.isFeatured !== undefined)
      finalEventData.isFeatured = req.body.isFeatured
